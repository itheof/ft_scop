...
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/base16-vim,~/.vim/bundle/vim-javascript,~/.vim/bundle/vim-jsx,~/.vim/bundle/vim-liquidsoap,~/.vim/bundle/vim-orgmode,~/.vim/bundle/color_coded,~/.vim/bundle/vim-glsl,~/.brew/Cellar/macvim/8.0-146_1/MacVim.app/Contents/Resources/vim/vimfiles,~/.brew/Cellar/macvim/8.0-146_1/MacVim.app/Contents/Resources/vim/runtime,~/.brew/Cellar/macvim/8.0-146_1/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/Library/Python/2.7/lib/python/site-packages/powerline/bindings/vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/base16-vim/after,~/.vim/bundle/vim-javascript/after,~/.vim/bundle/vim-jsx/after,~/.vim/bundle/vim-liquidsoap/after,~/.vim/bundle/vim-orgmode/after,~/.vim/bundle/color_coded/after,~/.vim/bundle/vim-glsl/after
set shiftwidth=4
set showmatch
set noshowmode
set smartcase
...
set shortmess=aoO
badd +3 src/ft_scop.c
badd +29 ft_scop.fs
badd +23 ft_scop.vs
badd +28 src/program.c
badd +50 ft_scop.h
badd +67 src/ppm.c
badd +1 src/shader.c
badd +1 src/file.c
badd +26 src/texture.c
badd +0 matrix.c
badd +0 src/matrix.c
badd +0 src/vector.c
argglobal
silent! argdel *
$argadd src/ft_scop.c
set stal=2
edit src/shader.c
...
16
normal! zo
let s:l = 44 - ((39 * winheight(0) + 20) / 40)
...
wincmd w
argglobal
if bufexists('src/file.c') | buffer src/file.c | else | edit src/file.c | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('src/texture.c') | buffer src/texture.c | else | edit src/texture.c | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('ft_scop.h') | buffer ft_scop.h | else | edit ft_scop.h | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
61
normal! zo
let s:l = 27 - ((11 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
wincmd w
argglobal
if bufexists('src/ft_scop.c') | buffer src/ft_scop.c | else | edit src/ft_scop.c | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
231
normal! zo
let s:l = 217 - ((56 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
217
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 97 - ((95 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
...
wincmd w
argglobal
if bufexists('src/matrix.c') | buffer src/matrix.c | else | edit src/matrix.c | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 79 - ((30 * winheight(0) + 40) / 80)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
...
wincmd w
argglobal
if bufexists('ft_scop.vs') | buffer ft_scop.vs | else | edit ft_scop.vs | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
